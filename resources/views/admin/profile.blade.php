...
<div class="container">
    <h2 id="adminName">{{ $user->name }}'s Profile</h2>

    <form id="profileForm" class="profile-form" method="POST" action="{{ route('admin.profile.update') }}">
        @csrf
    ...
    <div class="change-password">
        ...
        <form id="passwordForm" class="profile-form" method="POST" action="{{ route('admin.profile.password.update') }}">
            @csrf
    ...
    <div class="delete-account">
        ...
        <form id="deleteForm" method="POST" action="{{ route('admin.profile.delete') }}">
            @csrf
            @method('DELETE')
